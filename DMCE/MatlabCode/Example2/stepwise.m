function J0 = stepwise(x,y,fin,fout);
%
...
while ( p0<n ) & (length(p0)>0) & (length(p1)>0) & ((forward>0) | (backward>0)),
   ...
   F = (rss0-rss1)*(n-p0-1)/rss1;  % F-statistics
   Fenter= finv(1-fin, 1, n-p0-1);
   ...
   F =(rss0-rss1)*(n-p0)/rss1;
   
   F_out= finv(1-fout,1,n-p0);
