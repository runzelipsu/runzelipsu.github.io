...
rss0=sort(rss);
subplot(221)
plot(rss0(:,1),rss0(:,2),'.',[0,4.5],[0,4.5],'-')
axis([0,4.5,0,4.5])
xlabel('AR of Kriging')
ylabel('AR of SCAD')
title('(a) Absolute Residual')

subplot(222)
plot(rss0(:,1),rss0(:,3),'.',[0,7],[0,7],'-')
axis([0,7,0,7])
xlabel('AR of Kriging')
ylabel('AR of L_1')
...
subplot(223)
plot(rss0(:,1),rss0(:,4),'.',[0,4.5],[0,4.5],'-')
axis([0,4.5,0,4.5])
xlabel('AR of Kriging')
ylabel('AR of L_2')
