...
lambda=0.25*sqrt(log(n)/n);
lambda2=0.25*sqrt(log(n)/n);
lambda3=0.25*sqrt(log(n)/n);
...
[a,in]=max(ell3);
ga3 = 0.01*1.1^in./stdx;

[lambda_sel3,rss3] = cvl2(x,y,ga3);

[a3,b3,c3,d3,e3,f3]=penkrigl2(x,y,lambda,ga3)
